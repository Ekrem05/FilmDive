      ...
      <section className=" min-h-[2700px] flex sm:hidden  pt-40">
        <section className="flex flex-col gap-5  overflow-x-hidden items-center">
          <section className="w-full flex justify-center content-center">
            <Skeleton className="w-4/5 h-[625px] bg-secondarydrk self-center rounded-2xl" />
          </section>
          <section className="flex flex-col gap-6 w-4/5 items-center">
            <Skeleton className="w-full bg-secondarydrk h-14" />
            <section className="flex gap-4">
              <Skeleton className="w-8 bg-secondarydrk h-6" />
              <Skeleton className="w-8 bg-secondarydrk h-6" />
              <Skeleton className="w-8 bg-secondarydrk h-6" />
            </section>
            <Skeleton className="w-full bg-secondarydrk h-24" />
            <section className="flex gap-4">
              <Skeleton className="w-full bg-secondarydrk h-6" />
              <Skeleton className="w-full bg-secondarydrk h-6" />
            </section>
            <section className="flex gap-4">
              <Skeleton className="w-full bg-secondarydrk h-6" />
          ...
          <section className="flex gap-4 flex-col items-center pt-32">
            <Skeleton className="w-40 h-40 rounded-xl bg-secondarydrk " />
            <Skeleton className="w-40 h-40 rounded-xl bg-secondarydrk " />
            <Skeleton className="w-40 h-40 rounded-xl bg-secondarydrk " />
            <Skeleton className="w-40 h-40 rounded-xl bg-secondarydrk " />
          </section>
